module.exports = async function deploy(commonData) {
    ...
    console.log("Generating FarmingFactory Bytecode");

    var modelAddress = commonData.models.FarmMainRegularMinStake;
    ...
    var organizationFactoryLazyInitData = {
        ...
        factoryLazyInitData: web3.eth.abi.encodeParameters(["address", "address"], [commonData.models.FarmExtension, commonData.UNISWAP_V3_NONFUNGIBLE_POSITION_MANAGER])
    }
    ...
    data = web3.eth.abi.encodeParameters(["string", "address", "bytes"], [commonData.farmingFactoryUri, commonData.DYNAMIC_URI_RESOLVER, data]);
    data = web3.eth.abi.encodeParameters(["address", "bytes"], [commonData.fromAddress, data]);

    var Factory = await compile('ethereans/factories/impl/FarmingMinStakeUniV3Factory');
